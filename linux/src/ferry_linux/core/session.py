...
class FerrySession:
    ...
    def transition(self, new_state: SessionState) -> None:
        ...
        valid: dict[SessionState, set[SessionState]] = {
            ...
            SessionState.CONNECTING: {SessionState.HANDSHAKING, SessionState.FAILED, SessionState.CLOSING},
            SessionState.HANDSHAKING: {SessionState.AUTHENTICATING, SessionState.FAILED, SessionState.CLOSING},
            SessionState.AUTHENTICATING: {SessionState.ESTABLISHED, SessionState.PAIRING, SessionState.FAILED, SessionState.CLOSING},
            SessionState.PAIRING: {SessionState.WAITING_FOR_LOCAL_DECISION, SessionState.WAITING_FOR_REMOTE_DECISION, SessionState.FAILED, SessionState.CLOSING},
            SessionState.WAITING_FOR_LOCAL_DECISION: {SessionState.WAITING_FOR_REMOTE_DECISION, SessionState.PAIR_ACCEPTED, SessionState.FAILED, SessionState.CLOSING},
            SessionState.WAITING_FOR_REMOTE_DECISION: {SessionState.WAITING_FOR_LOCAL_DECISION, SessionState.PAIR_ACCEPTED, SessionState.FAILED, SessionState.CLOSING},
            SessionState.PAIR_ACCEPTED: {SessionState.ESTABLISHED, SessionState.FAILED, SessionState.CLOSING},
